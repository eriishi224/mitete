...
class _CreateProfileWidgetState extends State<CreateProfileWidget> {
  ...
  void initState() {
    ...
    _model.phoneNoEditFieldTextController ??= TextEditingController();
    _model.phoneNoEditFieldFocusNode ??= FocusNode();

    _model.shopurlEditFieldTextController ??= TextEditingController();
    _model.shopurlEditFieldFocusNode ??= FocusNode();
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'CREATE_PROFILE_PAGE_image_ON_TAP');
                                      logFirebaseEvent(
                                ...
                                if (_model.uploadedFileUrl != null &&
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'CREATE_PROFILE_PAGE_clear_ON_TAP');
                                        logFirebaseEvent(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.nameEditFieldTextController,
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primaryText,
                                  validator: _model
                                      .nameEditFieldTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.descriptionEditFieldTextController,
                                  focusNode:
                                      _model.descriptionEditFieldFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    isDense: true,
                            ...
                            if (_model.checkboxValue ?? true)
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.shopurlEditFieldTextController,
                                    focusNode: _model.shopurlEditFieldFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      isDense: true,
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: !((_model.uploadedFileUrl != null &&
                                _model.uploadedFileUrl != '') &&
                            (_model.fullnameFieldTextController.text != null &&
                                _model.fullnameFieldTextController.text !=
                                    '') &&
                            (_model.nameEditFieldTextController.text != null &&
                                _model.nameEditFieldTextController.text !=
                                    '') &&
                            (_model.descriptionEditFieldTextController.text !=
                                    null &&
                                _model.descriptionEditFieldTextController
                                        .text !=
                                    '') &&
                        ...
                        ? null
                        : () async {
                            logFirebaseEvent('CREATE_PROFILE_PAGE__BTN_ON_TAP');
                            ...
                            await currentUserReference!
                              ...
                              shopurl:
                                  _model.shopurlEditFieldTextController.text,
                              phoneNumber:
                                  _model.phoneNoEditFieldTextController.text,
