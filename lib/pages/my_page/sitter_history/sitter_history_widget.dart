...
import 'sitter_history_model.dart';
export 'sitter_history_model.dart';

class SitterHistoryWidget extends StatefulWidget {
  const SitterHistoryWidget({super.key});

  @override
  State<SitterHistoryWidget> createState() => _SitterHistoryWidgetState();
}

class _SitterHistoryWidgetState extends State<SitterHistoryWidget> {
  late SitterHistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SitterHistoryModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'sitterHistory'});
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      final listViewMatchRecord =
                                          listViewMatchRecordList[
                                              listViewIndex];
                                      return Visibility(
                                        visible: (listViewMatchRecord.status ==
                                        ...
                                        child: StreamBuilder<UsersRecord>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'SITTER_HISTORY_PAGE_listContainer_ON_TAP');
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            12.0),
                                                                    child: Text(
                                                                      '${listViewMatchRecord.paymentForSitter}円',
                                                                      textAlign:
                                                                          TextAlign
                                                                              .end,
