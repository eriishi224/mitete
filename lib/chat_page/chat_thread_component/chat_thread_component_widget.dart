...
import '/chat_page/chat_thread_update/chat_thread_update_widget.dart';
import '/chat_page/empty_state_simple/empty_state_simple_widget.dart';
              ...
              stream: queryChatMessagesRecord(
                ...
                limit: 200,
                  ...
                  if (_model.listViewPreviousSnapshot != null &&
                    ...
                    () async {
                      logFirebaseEvent(
                          'CHAT_THREAD_COMPONENT_ListView_5mmd7ytq_');
                    ...
                    return Container(
                      ...
                      child: wrapWithModel(
                        ...
                        child: ChatThreadUpdateWidget(
                          key: Key(
                            'Key5sp_${listViewChatMessagesRecord.reference.id}',
                          ),
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      logFirebaseEvent(
                                          'CHAT_THREAD_COMPONENT_TextField_t6g9nvu5');
                                      logFirebaseEvent(
